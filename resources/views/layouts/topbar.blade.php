	...
	<div class="header">
		<div class="header-left">
			...
			<div class="header-search" style="position: absolute;">
				<p class="text-center text-info h4" style="font-size: 17px;color: darkgoldenrod !important">{{ ENV('COMPANY_TITLE') }}    <i style="color: darkolivegreen"><small>Powered by</small> <a href="{{ Config::get('settings.website') }}" target="_blank"><i class="fa fa-copyright" aria-hidden="true">{{ ENV('APP_NAME') }}</i></a></p>
			</div>
		</div>
