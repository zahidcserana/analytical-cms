...
window.Dashboard = function () {
  $(document).ready(function () {
    var reportChart = $('#chart-report');
    var chartData = JSON.parse(reportChart.attr("data-chart"));
    var optionReport = {
      chart: {
        height: 350,
        type: 'bar',
    ...
    chart4.render();
    var chartReport = new ApexCharts(document.querySelector('#chart-report'), optionReport);
    chartReport.render();
          ...
          $.ajax({
            ...
            success: function success(response) {
              ...
              if (response.status) {
                ...
                total = invoice.total;
                subtotal = invoice.sub_total;
                var markup = "<tr>" + "<td><input type='checkbox' name='record' value='" + data.id + "'></td>" + "<td>" + data.buyer + "</td>" + "<td>" + data.style + "</td>" + "<td>" + data.color + "</td>" + "<td class='text-center'>" + data.width + "&times;" + data.length + "</td>" + "<td class='text-center'>" + data.area + "</td>" + "<td class='text-center'>" + data.quantity + "</td>" + "<td class='text-right'>" + data.price + "</td>" + "<td class='text-right'>" + data.amount + "</td> </tr>";
